...
> You can also only expose non-IKEA devices (which are not exposed to HomeKit with the native integration) with: `"expose: ["non-ikea-lightbulbs", "non-ikea-outlets", "non-ikea-blinds"]`
